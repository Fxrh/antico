...
void Antico::create_frame(Window c_win, Dockbar *dock, Desk *desk) // create new frame around the client app
{
    ...
    {
        frm = new Frame(c_win, frame_type.at(0), dock, desk, desk); // select always the first type in list (preferred)
...
void Antico::set_settings()
{
    ...
    if (antico->childGroups().isEmpty())
    {
        ...
        antico->setValue("path", "/home/rafal/antico/theme/default/");
    ...
    QSettings *style = new QSettings("/home/rafal/antico/theme/default/default.stl", QSettings::IniFormat, this);
