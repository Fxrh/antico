...
void Filedialog::read_settings()
{
    ...
    previous_dir_pix = stl_path + style->value("previous_dir_pix").toString();
    next_dir_pix = stl_path + style->value("next_dir_pix").toString();
...
void Filedialog::init()
{
    ...
    prev_dir_but = new QPushButton(QIcon(upper_dir_pix), "", this);
    prev_dir_but->setToolTip(tr("Previous directory"));    
    next_dir_but = new QPushButton(QIcon(upper_dir_pix), "", this);
    next_dir_but->setToolTip(tr("Next directory"));    

    path_layout->addWidget(prev_dir_but);   
    path_layout->addWidget(upper_dir_but);
    path_layout->addWidget(next_dir_but); 
...
void Filedialog::update_style()
{
    ...
    prev_dir_but->setIcon(QIcon(previous_dir_pix));
    next_dir_but->setIcon(QIcon(next_dir_pix));    
}
